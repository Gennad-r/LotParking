...
try {
    ...
    $mail->SMTPAuth = true;               
    $mail->Username = 'turniket@lotgroup.eu';
    $mail->Password = 'A5n3R7fPhY3f';
    $mail->SMTPSecure = 'ssl';
    $mail->Port = 465;

    //Recipients
    $mail->setFrom('turniket@lotgroup.eu', "Лэндинг парковки");
    //$mail->addAddress('gennad.r@gmail.com', 'Геннадию');
